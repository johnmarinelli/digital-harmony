...
const Uniforms = (modulatedIndex = 1, animationTime = 1.0) =>
  THREE.UniformsUtils.merge([
    THREE.ShaderLib['basic'].uniforms,
    {
      time: { type: 'f', value: 0 },
      startedAt: { type: 'f', value: 0 },
      animationTime: { type: 'f', value: animationTime },
      modulatedIndex: { type: 'i', value: 1 },
    },
  ])
const VertexShader = `
varying vec3 vColor;
uniform float time;
uniform float startedAt;
